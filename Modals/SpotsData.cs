...
namespace f2e_week2_filter.Models
{
    ...
    public partial class SpotsData
    {
        [JsonProperty("help")]
    ...
    public partial class SpotsData
    {
        public static SpotsData FromJson(string json) => JsonConvert.DeserializeObject<SpotsData>(json, f2e_week2_filter.Models.Converter.Settings);
    }
    ...
    {
        public static string ToJson(this SpotsData self) => JsonConvert.SerializeObject(self, f2e_week2_filter.Models.Converter.Settings);
    }
